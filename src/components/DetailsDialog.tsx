  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to Quiz.io!</DialogTitle>
          <DialogDescription>
            ...
            <p className="my-2 mt-4 ">
              ...
              the ordinary and embrace the extraordinary with Quiz.io! Our
              platform is revolutionizing the quiz and trivia experience by
              harnessing the immense potential of artificial intelligence.Join the Fun and Invite others too!!
            </p>
            <hr />
